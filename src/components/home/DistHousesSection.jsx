    ...
    <section className="mt-12">
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          <div className="bg-secondary p-8 rounded-lg shadow-regular flex flex-col [&>*:nth-child(3)]:flex-1 [&>*:last-child]:self-start">
            <img className="h-[60px] self-start mb-6" src={akashMedia} alt="Akash Media Logo" />
            <h3 className="text-2xl font-medium mb-2">Akash Media</h3>
          ...
          <div className="bg-secondary p-8 rounded-lg shadow-regular flex flex-col [&>*:nth-child(3)]:flex-1 [&>*:last-child]:self-start">
            ...
            <h3 className="text-2xl font-medium mb-2">Media Trade</h3>
          ...
          <div className="bg-secondary p-8 rounded-lg shadow-regular flex flex-col [&>*:nth-child(3)]:flex-1 [&>*:last-child]:self-start lg:col-start-2 xl:col-start-auto">
            <img className="h-[60px] self-start mb-6" src={mediaLink} alt="Media Link Logo" />
            <h3 className="text-2xl font-medium mb-2">Media Link</h3>
