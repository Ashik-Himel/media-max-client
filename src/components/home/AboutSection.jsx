  ...
  return (
    <section className='mt-6'>
      <div className="container">
        <h2 className='text-center text-[2rem] font-semibold mb-2'><span className="text-primary">About</span> Us</h2>
        ...
        <div className='flex flex-col-reverse md:flex-row justify-center items-center gap-8 [&>*]:flex-1'>
          <div>
            <img className='block w-full max-w-[450px] mx-auto' src={aboutImg} alt="About Section Image" />
          </div>
          <div>
