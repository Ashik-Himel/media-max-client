    ...
    <section>
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          <div className="bg-secondary p-8 rounded-lg shadow-regular flex flex-col [&>*:nth-child(2)]:flex-1 [&>*:last-child]:self-start" data-aos="fade-up">
            ...
            <Link to='contact' spy={true} smooth={true} duration={500} activeClass="active" className="btn btn-primary cursor-pointer select-none">Contact Us</Link>
          </div>
          <div className="bg-secondary p-8 rounded-lg shadow-regular flex flex-col [&>*:nth-child(2)]:flex-1 [&>*:last-child]:self-start" data-aos="fade-up">
          ...
          <div className="bg-secondary p-8 rounded-lg shadow-regular flex flex-col [&>*:nth-child(2)]:flex-1 [&>*:last-child]:self-start lg:col-start-2 xl:col-start-auto" data-aos="fade-up">
